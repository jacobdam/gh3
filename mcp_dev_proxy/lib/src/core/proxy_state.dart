...
class ProxyState {
  ...
  Map<dynamic, MCPMessage> get pendingRequests => Map.unmodifiable(_pendingRequests);
  Map<dynamic, DateTime> get requestTimestamps => Map.unmodifiable(_requestTimestamps);
  
  // Read-only access to tool cycle tracking
  Set<String> get pendingToolUses => Set.unmodifiable(_pendingToolUses);
  Map<String, DateTime> get toolUseTimestamps => Map.unmodifiable(_toolUseTimestamps);
