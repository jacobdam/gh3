...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(GGetUserDetailsData_user_organizations.serializer)
          ..add(GGetUserDetailsData_user_repositories.serializer)
          ..add(GGetUserDetailsData_user_starredRepositories.serializer)
          ..add(GGetUserDetailsData_user_status.serializer)
          ...
          ..add(GRepositoryCardFragmentData.serializer)
          ..add(GRepositoryCardFragmentData_primaryLanguage.serializer)
          ..add(GRepositoryCardFragmentReq.serializer)
          ..add(GRepositoryCardFragmentVars.serializer)
          ...
          ..add(GUserCardFragmentData.serializer)
          ..add(GUserCardFragmentData_followers.serializer)
          ..add(GUserCardFragmentData_repositories.serializer)
          ..add(GUserCardFragmentReq.serializer)
          ..add(GUserCardFragmentVars.serializer)
          ..add(GUserProfileFragmentData.serializer)
          ..add(GUserProfileFragmentData_followers.serializer)
          ..add(GUserProfileFragmentData_following.serializer)
          ...
          ..add(GUserStatusFragmentVars.serializer)
